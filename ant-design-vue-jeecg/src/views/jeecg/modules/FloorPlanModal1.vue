<template>
  <a-modal
    ...
    <a-spin :spinning="confirmLoading" style="height: 378px;width: 755px;margin-left: 12px">
      <a-form :form="form">
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'oneAreaId','twoAreaId','customerId','floorName','planPic','remark',))
          //时间格式化
        });
      ...
      handleOk () {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            let planPic = that.model.planPic;
            let formData = Object.assign(this.model, values);
            formData.planPic = planPic;
            let httpurl = '';
            let method = '';
            if(!this.model.id){
