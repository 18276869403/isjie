...
<!--          :labelCol="labelCol"-->
<!--          :wrapperCol="wrapperCol"-->
<!--          label="区域"  class="a-form">-->
<!--          <a-select v-decorator="[ 'backUp2', validatorRules.backUp2]" placeholder="请选择客户区域"  class="a-input">-->
<!--            <a-select-option value="">全部</a-select-option>-->
<!--            <a-select-option v-for="(backUp2,backUp2index) in getBackUp2" :key="backUp2index.toString()" :value="backUp2.id">{{backUp2.name}}</a-select-option>-->
<!--          </a-select>-->
<!--        </a-form-item>-->
       ...
       <!-- <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="厂房"  class="a-form">
          <a-select v-decorator="[ 'customerId', validatorRules.customerId]" placeholder="请选择厂房"  class="a-input">
            <a-select-option value="">全部</a-select-option>
            <a-select-option v-for="(custor,customeex) in getCustomers" :key="customerindex.toString()" :value="customer.id">{{customer.ne}}</a-select-option>
          </a-select>
        </a-form-item>-->
...
<!--          :wrapperCol="wrapperCol"-->
<!--          label="区域"  class="a-form">-->
<!--          <a-select v-decorator="[ 'deviceAreaId', validatorRules.deviceAreaId]" placeholder="请选择客户区域"  class="a-input">-->
<!--            <a-select-option value="">全部</a-select-option>-->
<!--            <a-select-option v-for="(deviceArea,deviceAreaindex) in getDeviceArea" :key="deviceAreaindex.toString()" :value="deviceArea.id">{{deviceArea.areaName}}</a-select-option>-->
<!--          </a-select>-->
<!--        </a-form-item>-->
        ...
        <!--<a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="区域"  class="a-form">
          <a-select v-decorator="[ 'customerId', validatorRules.customerId]" placeholder="请选择区域"  class="a-input">
            <a-select-option value="">全部</a-select-option>
            <a-select-option v-for="a in getCustome" :key="customerindex.toString()" :value="customer.id">{{customer.na}}</a-select-option>
          </a-select>
        </a-form-item>
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        ...
        validatorRules:{
          ...
          deviceAreaId:{rules: [{ required: true, message: '请输入区域!' }]},
          BackUp3:{rules: [{ required: true, message: '请输入厂房!' }]},
    ...
    methods: {
      ...
      //获取所有的(区域)
      initialGetBackUp2List(id){
        this.getCustomers = ['']
        getBackUp2All().then((res) => {
          if (res.success){
            this.getBackUp2 = res.result
          } else {
            /!* console.log(res.message)*!/
          }
        })
