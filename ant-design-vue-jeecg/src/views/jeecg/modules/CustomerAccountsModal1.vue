<template>
  <a-modal
    ...
    @cancel="handleCancel"
    cancelText="关闭"
    style="position: absolute;top: 50%;left: 45%;margin-top: -300px;margin-left:-225px;">
      ...
      <a-form :form="form" style="margin-left: 15px;">
        ...
        <template v-if="!model.id">
          <a-form-item
            ...
            <a-radio-group v-decorator="['shortLetter', validatorRules.shortLetter]" style="margin-left: 10px;" @change="change1">   <!--v-decorator="[ 'shortLetter', validatorRules.shortLetter]"-->
