<template>
  <a-modal
    ...
    <a-spin :spinning="confirmLoading" style="height: 622px;margin-left: 75px">
      <a-form :form="form" style="width: 825px;">
        ...
        <a-form-item
          ...
          <a-input placeholder="请输入设备IMEI" v-decorator="['deviceImei',validatorRules.deviceImei]" class="a-input2"/>
        </a-form-item>
    ...
    <a-form-item
          ...
          <a-input placeholder="请输入ICCID" v-decorator="['iccid', validatorRules.iccid]" class="a-input2" />
        </a-form-item>
        ...
        <a-form-item
          ...
          <a-input placeholder="请输入设备ADD" v-decorator="['addressNumber', validatorRules.addressNumber]" class="a-input2"/>
        </a-form-item>
    ...
    <a-spin :spinning="confirmLoading" style="height: 622px;margin-left: 75px">
      <a-form :form="form" style="width: 825px;">
        ...
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="状态" class="a-form-item" style="border: 1px solid red">
          <a-select v-if="!model.id"  v-decorator="[ 'StatusType', validatorRules.StatusType]" placeholder="请选择状态">
          ...
          <a-select v-else v-decorator="[ 'StatusType', {}]" placeholder="请选择状态">
            <a-select-option :value="正常">正常</a-select-option>
            <a-select-option :value="故障">故障</a-select-option>
            <a-select-option :value="报警">报警</a-select-option>
            <a-select-option :value="维护">维护</a-select-option>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'oneAreaId','twoAreaId','customerId','deviceType', 'addressNumber','deviceNum','deviceModel','deviceImei','factoryNum','detectionTarget','ranges','unit', 'reductionCoefficient','iccid','installationPosition','remark'))
          //时间格式化
        });
      },
      close () {
