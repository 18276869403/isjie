        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="日志内容">
              <a-input placeholder="请输入日志内容" v-model="queryParam.keyWord"></a-input>
            </a-form-item>
          </a-col>
          ...
          <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
            <a-col :md="6" :sm="24" >
                <a-button type="primary"  style="left: 5px" @click="searchQuery" icon="search">查询</a-button>
                <a-button type="primary"  @click="searchReset" icon="reload" style="margin-left: 5px;left: 10px">重置</a-button>
              <a-popconfirm title="确认清空全部的日志吗" @confirm="() => delete1('allclear')">
                 <a-button type="primary" style="margin-left: 10px;left: 10px">一键清空</a-button>
              </a-popconfirm>
            </a-col>
          </span>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      delete1(allclear){
        deleteAction('/sys/log/deleteBatch',{ids:allclear}).then((res) => {
        })
        this.searchReset();
      },
