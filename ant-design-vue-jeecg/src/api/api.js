...
//用户管理
const checkuser = (params)=>getAction("/sys/user/queryByName",params);
...
//一二级区域
/*const getoneAreaall = (params)=>getAction("/monitor/oneArea/getoneall",params);*/
const oneAreaallStatus = (params)=>getAction("/monitor/oneArea/oneallStatus",params);
const oneAreaStatus = (params)=>putAction("/monitor/oneArea/oneStatus",params);
const areaAppointlist = (params)=>getAction("/monitor/twoArea/appointlist",params);
const twoAreaStatus = (params)=>putAction("/monitor/twoArea/twoStatus",params);
const twoZd = (params)=>getAction("/monitor/twoArea/twoZd",params);

//获取所有的一级区域
const getOneAreaAll = (params)=>getAction("/monitor/area/getOneAreaAll",params);
//获取所有的二级区域
const getTwoAreaAll = (params)=>getAction("/monitor/area/getTwoAreaAll",params);
//状态
const custStates = (params)=>putAction("/monitor/customerAccounts/custState",params);
//获取所有的客户信息
const getCustomersAll = (params)=>getAction("/monitor/customers/getCustomersAll",params);
