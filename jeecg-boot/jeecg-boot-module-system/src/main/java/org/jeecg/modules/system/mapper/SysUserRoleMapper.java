...
public interface SysUserRoleMapper extends BaseMapper<SysUserRole> {
	...
	@Select("select role_name from sys_role where id in (select role_id from sys_user_role where user_id = (select id from sys_user where username=#{username} and del_flag = '0'))")
