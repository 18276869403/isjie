...
public interface SysUserMapper extends BaseMapper<SysUser> {
	 ...
	 * @return
	 */
	IPage<SysUserVo> custoMpage(Page<SysUserVo> page, @Param(Constants.WRAPPER) Wrapper<SysUserVo> queryWrapper);
    ...
    void shouJuMSG(@Param("id")String id,@Param("status") String status);
}
