<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('客户账号表')">导出</a-button>
  ...
  export default {
    ...
    data () {
      return {
        ...
        columns: [
          {
		   ...
		   {
            title: '接受报警短信1-接受，2-拒绝',
            align:"center",
            dataIndex: 'shortLetter'
           },
		   {
            title: '接受手机号(接收报警短信时，填手机号)',
            align:"center",
            dataIndex: 'phone'
           },
		   {
		...
		url: {
          list: "/monitor/customerAccounts/list",
